    ...
    <footer className="bg-gray-800 text-white p-6 mt-8">
      <div className={`container mx-auto text-center grid gap-8 ${getGridClass()}`}>
        ...
        <div className="flex justify-center items-center">
          <img src="https://img.freepik.com/free-vector/hospital-logo-green-blue_1043-66.jpg?t=st=1761470248~exp=1761473848~hmac=38afd7e54f06302141002011f69fbfb20fe9b36a50e88f6e168e5ca57f298fe7&w=1480" alt="Hospital Logo" className="w-16 h-auto rounded" />
        </div>
